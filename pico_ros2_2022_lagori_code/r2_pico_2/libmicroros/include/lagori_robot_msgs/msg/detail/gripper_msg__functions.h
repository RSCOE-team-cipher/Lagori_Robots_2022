...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__GripperMsg__are_equal(const lagori_robot_msgs__msg__GripperMsg * lhs, const lagori_robot_msgs__msg__GripperMsg * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__GripperMsg__copy(
  const lagori_robot_msgs__msg__GripperMsg * input,
  lagori_robot_msgs__msg__GripperMsg * output);
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__GripperMsg__Sequence__are_equal(const lagori_robot_msgs__msg__GripperMsg__Sequence * lhs, const lagori_robot_msgs__msg__GripperMsg__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__GripperMsg__Sequence__copy(
  const lagori_robot_msgs__msg__GripperMsg__Sequence * input,
  lagori_robot_msgs__msg__GripperMsg__Sequence * output);
