...
/// Check for msg/R2LimitSwitchStepper2 message equality.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__R2LimitSwitchStepper2__are_equal(const lagori_robot_msgs__msg__R2LimitSwitchStepper2 * lhs, const lagori_robot_msgs__msg__R2LimitSwitchStepper2 * rhs);

/// Copy a msg/R2LimitSwitchStepper2 message.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__R2LimitSwitchStepper2__copy(
  const lagori_robot_msgs__msg__R2LimitSwitchStepper2 * input,
  lagori_robot_msgs__msg__R2LimitSwitchStepper2 * output);
...
/// Check for msg/R2LimitSwitchStepper2 message array equality.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence__are_equal(const lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence * lhs, const lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence * rhs);

/// Copy an array of msg/R2LimitSwitchStepper2 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
ROSIDL_GENERATOR_C_PUBLIC_lagori_robot_msgs
bool
lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence__copy(
  const lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence * input,
  lagori_robot_msgs__msg__R2LimitSwitchStepper2__Sequence * output);
